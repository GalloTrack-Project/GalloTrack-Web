        ...
        <div className="absolute z-50 mt-1.5 w-full bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden max-h-64 overflow-y-auto">
          ...
          >
            ...
            <span className="flex-1 min-w-0">
              ...
              <span className="block text-[9px] font-semibold text-slate-400">Not registered yet — keeps custom lineage tracking</span>
            </span>
          </button>
        </div>
      )}
                            ...
                            <div className="flex-1 w-full space-y-3">
                              ...
                              <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100">
                                ...
                                <button 
                                  type="button" 
                                  onClick={() => setPendingPermanentDelete(fowl)}
                                  className="flex-1 min-w-[95px] bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200/80 text-[11px] font-black py-2 rounded-xl text-center cursor-pointer transition-all duration-150 flex items-center justify-center gap-1.5 shadow-2xs"
                                >
